...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/theme_css/font-awesome.min.css">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/theme_css/magnific-popup.css">
			...
			<div class="row counter_wrapper">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single_feature">
						<div class="thumb">
							<img src="${pageContext.request.contextPath}/resources/img/features/1.png" alt="">
						</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single_feature">
						<div class="thumb">
							<img src="${pageContext.request.contextPath}/resources/img/features/2.png" alt="">
						</div>
						<div class="info-content">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single_feature">
						<div class="thumb">
							<img src="${pageContext.request.contextPath}/resources/img/features/3.png" alt="">
						</div>
						<div class="info-content">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single_feature">
						<div class="thumb">
							<img src="${pageContext.request.contextPath}/resources/img/features/4.png" alt="">
						</div>
						<div class="info-content">
					...
					<div class="right-bottom-area">
						<div class="author-lacture">
							...
							<div class="author-title">
								<div class="thumb"><img src="${pageContext.request.contextPath}/resources/img/about-author.png" alt=""></div>
								<div class="a-desc">
									<h6>Marvel Maison</h6>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-service">
						<div class="service-thumb">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/service/service1.jpg" alt="">
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-service">
						<div class="service-thumb">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/service/service2.jpg" alt="">
						</div>
						<div class="service-details">
							<h5><a href="#">Get to Know Project Estimate?</a></h5>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed eiusmod tempor incididunt labore dolore magna
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-service">
						<div class="service-thumb">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/service/service3.jpg" alt="">
						</div>
						<div class="service-details">
							<h5><a href="#">Get to Know Project Estimate?</a></h5>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed eiusmod tempor incididunt labore dolore magna
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="left-image">
									<div class="s-img"><img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/service/service4.jpg" alt=""></div>
									<div class="s-img"><img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/service/service5.jpg" alt=""></div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="right-image">
										<div class="s-img"><img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/service/service6.jpg" alt=""></div>
										<div class="s-img"><img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/service/service7.jpg" alt=""></div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single_member">
						<div class="author">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/team/team1.jpg" alt="">
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single_member">
						<div class="author">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/team/team2.jpg" alt="">
						</div>
						<div class="author_decs">
							<h5>Ethel Davis</h5>
							<p class="profession">Senior Barrister at law</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single_member">
						<div class="author">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/team/team3.jpg" alt="">
						</div>
						<div class="author_decs">
							<h5>Ethel Davis</h5>
							<p class="profession">Senior Barrister at law</p>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/blog/h-blog1.jpg" alt="">
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/blog/h-blog2.jpg" alt="">
						</div>
						<div class="blog-details">
							<div class="blog-meta">
								<span>25 june, 2018 | By Mark Wiens</span>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/blog/h-blog3.jpg" alt="">
						</div>
						<div class="blog-details">
							<div class="blog-meta">
								<span>25 june, 2018 | By Mark Wiens</span>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="${pageContext.request.contextPath}/resources/theme_js/popper.js"></script>
	<script src="${pageContext.request.contextPath}/resources/theme_js/bootstrap.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/theme_js/stellar.js"></script>
	<script src="${pageContext.request.contextPath}/resources/theme_js/jquery.magnific-popup.min.js"></script>
	...
	<script src="${pageContext.request.contextPath}/resources/theme_js/jquery.ajaxchimp.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/vendors/counter-up/jquery.waypoints.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/vendors/counter-up/jquery.counterup.js"></script>
	<script src="${pageContext.request.contextPath}/resources/theme_js/mail-script.js"></script>
	<!--gmaps Js-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
	<script src="${pageContext.request.contextPath}/resources/theme_js/gmaps.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/theme_js/theme.js"></script>
</body>
